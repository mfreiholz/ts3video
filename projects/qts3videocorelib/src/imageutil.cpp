...
int rcoeff(int y, int u, int v){ return 298082*y +      0*u + 408583*v; }
int gcoeff(int y, int u, int v){ return 298082*y - 100291*u - 208120*v; }
int bcoeff(int y, int u, int v){ return 298082*y + 516411*u +      0*v; }
